...
" goyo - middle screen text

map <leader>m :Goyo<LF> " \| set linebreak<LF>
...
" neomake
" basically turn off neomake automake for python files because it doesn't
" understand modern syntax and is very annoying.
autocmd Filetype * if &ft!="python"|call neomake#configure#automake('w')|endif
let g:neomake_open_list = 2
au FileType python let g:neomake_open_list = 0
